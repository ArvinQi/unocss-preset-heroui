...
import type { ColorOptions, PresetNextUIOptions } from "./types";
...
export function generateCSSVars(
  ...
  if (!color) {
    if (radius) cssStyle += radiusCSSVarsStyles(radius);
  } else {
